...
CREATE TABLE lotes (
  ...
  peso_bruto_ingreso DECIMAL(12,3) NOT NULL COMMENT 'Peso total al ingresar al almacen',
...
CREATE TABLE lote_clasificacion (
  ...
  peso_bruto    DECIMAL(12,3) NOT NULL COMMENT 'Peso bruto de esta categoria',
  numero_jabas  INT           NOT NULL DEFAULT 0,
  peso_jabas    DECIMAL(12,3) NOT NULL DEFAULT 0.000 COMMENT 'Peso descontado por jabas',
  porcentaje_humedad DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  peso_descuento_humedad DECIMAL(12,3) NOT NULL DEFAULT 0.000,
  peso_neto     DECIMAL(12,3) NOT NULL COMMENT 'Peso final = bruto - jabas - humedad',
...
CREATE TABLE liquidacion_detalle (
  ...
  numero_jabas        INT           NOT NULL DEFAULT 0,
  peso_jabas          DECIMAL(12,3) NOT NULL DEFAULT 0.000,
  porcentaje_humedad  DECIMAL(5,2)  NOT NULL DEFAULT 0.00,
  peso_descuento_humedad DECIMAL(12,3) NOT NULL DEFAULT 0.000,
  peso_neto           DECIMAL(12,3) NOT NULL COMMENT 'Peso final despues de descuentos',
